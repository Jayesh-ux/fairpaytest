            ...
            <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        <div className="glass-card-strong p-8 rounded-3xl shadow-xl">
                            ...
                            <div className="space-y-4 text-muted-foreground leading-relaxed">
                                <p>
                                    <Link href="/how-it-works" className="font-semibold text-foreground hover:text-primary transition-colors">FairPay Solution</Link> is an independent unsecured loan advisory consultancy created to support borrowers facing financial stress and recovery-related challenges.
                                </p>
                                ...
                                <p className="text-sm italic border-l-4 border-primary pl-4 py-2 bg-primary/5 rounded">
                                    We are not a bank, NBFC, or lending institution. All services are advisory in nature. View our <Link href="/loan-policy" className="underline">Loan Type Policy</Link>.
                                </p>
                            </div>
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-3xl mx-auto">
                        FairPay Solution is an independent advisory consultancy. We are <span className="font-semibold text-foreground">not a bank, NBFC, or lending institution</span>. We do not provide loans, credit, or financial products. Our services are purely advisory and educational in nature. All consultations are appointment-based. Learn more about <Link href="/eligibility" className="text-primary hover:underline">eligibility</Link> or use our <Link href="/calculator" className="text-primary hover:underline">debt calculator</Link>.
                    </p>
                </motion.div>
            </div>
        </section>
