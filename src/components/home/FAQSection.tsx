...
const faqs = [
  {
    ...
    answer: "Typically, clients find substantial savings on their outstanding debt amount. The exact savings depend on factors like the type of loan, outstanding amount, and your lender. Our experts analyze your case to maximize your resolution.",
  },
  {
