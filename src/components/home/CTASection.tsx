  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-1/4 left-1/3 w-64 h-64 rounded-full bg-teal-light/20 blur-3xl"
      />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span>Average settlement time: 24-48 months</span>
          </motion.div>
          ...
          >
            Join thousands of Americans who've successfully settled their debts 
