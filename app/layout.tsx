...
export const metadata: Metadata = {
    ...
    description:
        'FairPay Solutions provides legal debt settlement guidance in India. Reduce loans by 40-60%. Understand options for credit cards & personal loans. RBI compliant.',
    keywords: [
